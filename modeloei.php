	...
	<head>
        ...
        <!-- <section class="dining-section drinks sec-padding">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <img class="img-bordered" src="img/dining/dining-and-bar-2.jpg" alt="drinks">
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <ul class="menu-list">
                            <li class="menu-item">
                                <div class="menu-item-header">
                                    <h4>Crumbed Whiting</h4>
                                    <h4 class="menu-item-price">$45.89</h4>
                                </div>
                                <div class="menu-item-main">
                                    <p>Fresh local baby whiting fillets in a sesame and parsley crumb s/w chips salad lemon and tartare... This is a lunch that will leave you asking for more!</p>
                                </div>
                            </li>
                            <li class="menu-item">
                                <div class="menu-item-header">
