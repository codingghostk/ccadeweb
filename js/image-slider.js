...
var arr=['img/slider/baner1.jpg','img/slider/baner2.jpg','img/slider/baner3.jpg','img/slider/baner4.jpg']; //an array of image sources
var arrText= ['40 años de experiencia y resultados contundentes','Optimizar el funcionamiento organizacional desarrollando personas','Expertos en Optimización Organizacional','Líderes en evolución organizacional desde 1978'];
...
$(document).ready(function () {
    ...
    $('#slider').html('<img src="'+arr[0]+'" class="img-slide image-animated""><div class="carousel-caption"><h1>"'+arrText[0]+'"</h1></div>');//show first image
    ...
    function autoSlide(arr,interval){
        ...
        setInterval(function () {
            ...
            $('#slider').html('<img src="'+arr[pos]+'" class="img-slide img'+pos+' image-animated"><div class="carousel-caption"><h1>"'+arrText[pos]+'"</h1></div>');//shows image
    ...
    function next(){
        ...
        $('#slider').html('<img src="'+arr[pos+1]+'" class="img-slide image-animated"><div class="carousel-caption"><h1>"'+arrText[pos+1]+'"</h1></div>');//show image
        pos++;
    ...
    function previous() {
        ...
        $('#slider').html('<img src="'+arr[pos-1]+'" class="img-slide image-animated"><div class="carousel-caption"><h1>"'+arrText[pos-1]+'"</h1></div>');
        pos--;
